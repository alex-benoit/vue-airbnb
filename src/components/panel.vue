...
export default {
  ...
  computed: {
    mapUrl: function(){
      return `https://maps.googleapis.com/maps/api/staticmap?center=${this.selectedFlat.lat},${this.selectedFlat.lng}&zoom=14&size=480x250&markers=${this.selectedFlat.lat},${this.selectedFlat.lng}`
    }
  }
};
</script>
